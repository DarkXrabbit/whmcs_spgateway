 ...
 * @return array
 */
function spgateway_barcode_MetaData() {
    return array(
        'DisplayName' => 'spgateway - 超商條碼',
 ...
 * @return array
 */
function spgateway_barcode_config() {
    return array(
...
function spgateway_barcode_link($params) {
