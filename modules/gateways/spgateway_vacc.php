<?php
/**
 * WHMCS spgateway Virtual Account
 *
 ...
 * @return array
 */
function spgateway_vacc_MetaData() {
    return array(
        'DisplayName' => 'spgateway - 虛擬帳號',
 ...
 * @return array
 */
function spgateway_vacc_config() {
    return array(
...
function spgateway_vacc_link($params) {
