 ...
 * @return array
 */
function spgateway_cvs_MetaData() {
    return array(
        'DisplayName' => 'spgateway - 超商代碼',
...
function spgateway_cvs_link($params) {
    ...
    if ( $TotalAmount < 30 || $TotalAmount > 20000 ) return 'Error Amount';
