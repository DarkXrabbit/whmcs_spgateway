 ...
 * @return array
 */
function spgateway_webatm_MetaData() {
    return array(
        'DisplayName' => 'spgateway - WebATM',
 ...
 * @return array
 */
function spgateway_webatm_config() {
    return array(
        // the friendly display name for a payment gateway should be
        // defined here for backwards compatibility
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => 'spgateway Web ATM',
        ),
...
function spgateway_webatm_link($params) {
    ...
    <input type=hidden name="NotifyURL" value="'.$systemurl.'/modules/gateways/callback/spgateway.php">
